...
# Put your Google Drive folder URL here
...
with st.spinner("📥 Loading Google Drive knowledge base..."):
    ...
    success, error = download_google_drive_folder(
        drive_url
    )
...
if not success:
    ...
    st.error(
        "Could not download the Google Drive folder."
    )
...
if not documents:
    ...
    st.info(
        "Add PDF, DOCX, TXT or MD files inside "
        "your Google Drive knowledge-base folders."
    )
